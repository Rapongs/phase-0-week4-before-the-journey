...
mendapatkan satu digit. Wajib menggunakan rekursif untuk berlatih rekursif, namun kamu boleh menggunakan
looping juga disini.
...
function kaliTerusRekursif(angka) {
  ...
  let hasilKali = (angka % 10) * kaliTerusRekursif(Math.floor(angka / 10))
  if (hasilKali >= 10 ) {
